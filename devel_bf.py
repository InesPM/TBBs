...
calsign=1 # to be used in filename and beamforming calculation. Should be 1, but can be different for testing
bfsign=1 # to be used in filename and beamforming calculation Should be 1, but can be different for testing
assert(pol in [0,1])
assert(calsign in [-1,1])
...
for sb in subbands[0:]:
 ...
 #       print("Analysing dipole",d,"at offset",o,)
        ...
        # TODO: Check signs
        bfdata+=sbdata_complex*caltable[dnr,sbnr]*weights[dnr]/(1.0*len(available_dipoles))
